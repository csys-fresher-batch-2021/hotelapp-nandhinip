...
<body>
		...
		<form action="LoginServlet" method="post">
			<table class="table table-borderless">
				...
				<tbody>
					<tr>
					<tr>
						<th scope="col"><label for="MobileNumber">Mobile
								Number</label></th>
						<th scope="col"><input type="tel" name="userPh" id="userPh"
							placeholder="10-digit number" onchange="mobNo()"
							pattern="[0-9]{10}" min=0 required></th>
					</tr>

					<tr>
						<th scope="col"><label for="password">Password</label></th>
						<th scope="col"><input type="password" name="pwd" id="pwd"
							placeholder=*** onchange="password()" pattern="[a-z0-9]{8}"
							min="8" required></th>
					</tr>
				</tbody>
			</table>
	...
	<div class="info">
		<p>
			<strong>! </strong>Admin(Mobile Number:9900990090, Password:admin123)
		</p>
	</div>
